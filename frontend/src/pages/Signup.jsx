...
import avatar from '../assets/images/cleaner1.jpg';
    ...
    return <section className="px-5 xl:px-0">
        <div className="max-w-[1170px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2">
                {/*------img box------ */}
                <div className="hidden lg:block rounded-l-lg" style={{ marginTop: "-30px" }}>
                ...
                <div className="rounded-l-lg lg:pl-16 py-10">
                    ...
                    <button 
                      disabled={loading}
                    type="submit" 
                    className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3">{loading ? <HashLoader size={35} color="#FFFF"/> : 'Sign Up'}</button>
                   </div>
                   <p className="mt-5 text-textColor text-center">Already have an account? <Link to="/login" className="text-primaryColor font-medium ml-1">Login</Link>
            </p>
                    </form>
                </div>
            </div>
